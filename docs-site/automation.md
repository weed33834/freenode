...
FreeNode 的日常运维主要由 GitHub Actions 驱动，从节点抓取、解析、校验到站点部署基本实现无人值守。
...
| `deploy-docs.yml` | `docs-site/**` 变更 / 手动触发 | 构建 VitePress 文档站并部署到 GitHub Pages |
...
当 `docs-site/` 目录发生变更或手动触发时，部署工作流会：
